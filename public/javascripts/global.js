...
function getresult() {
    ...
    //$('#clickme').click(function() {
         ...
         */
    //alert($('#loadCount').val());
    var ustring = 'http://api.indeed.com/ads/apisearch?publisher=3818743618433097&format=json&q=ui,android,ios,bigdata,mobile,cloud&l=&sort=&radius=&st=&jt=&start=' + (parseInt($('#loadCount').val())+24) +'&limit=24&fromage=&filter=&latlong=1&co=in&chnl=&userip=1.2.3.4&useragent=Mozilla/%2F4.0%28Firefox%29&v=2'
//alert(ustring);
        $.ajax({
